  ...
  const HomePage = () => {
    ...
    return (
      <div className="min-h-screen bg-gradient-to-br from-blue-50 via-indigo-50 to-purple-50">
        {/* Hero Section */}
        <div className="relative overflow-hidden bg-gradient-to-r from-blue-600 via-blue-700 to-indigo-800 text-white py-20 px-4">
        ...
        <div className="py-16 px-4">
          <div className="max-w-7xl mx-auto">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-16">
              {/* Feature 1 */}
              <div className="bg-white rounded-xl shadow-lg p-8 hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-2 border-t-4 border-blue-500">
              ...
              {/* Feature 2 */}
              <div className="bg-white rounded-xl shadow-lg p-8 hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-2 border-t-4 border-green-500">
              ...
              {/* Feature 3 */}
              <div className="bg-white rounded-xl shadow-lg p-8 hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-2 border-t-4 border-purple-500">
        ...
        <div className="py-16 px-4 bg-white">
          <div className="max-w-7xl mx-auto">
            <div className="text-center mb-12">
              ...
              <p className="text-xl text-gray-600">Choose an option below to begin</p>
            </div>

            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              {/* Register Birth Card */}
              <div className="bg-gradient-to-br from-blue-50 to-blue-100 rounded-xl shadow-lg p-8 border-2 border-blue-200 hover:border-blue-400 transition-all duration-300 transform hover:scale-105">
                <div className="text-center">
                  ...
                  <h3 className="text-2xl font-bold text-gray-800 mb-3">Register Birth</h3>
              ...
              {/* Check Status Card */}
              <div className="bg-gradient-to-br from-green-50 to-green-100 rounded-xl shadow-lg p-8 border-2 border-green-200 hover:border-green-400 transition-all duration-300 transform hover:scale-105">
                <div className="text-center">
                  ...
                  <h3 className="text-2xl font-bold text-gray-800 mb-3">Check Status</h3>
                  <p className="text-gray-700 mb-6 leading-relaxed">
              ...
              <div className="bg-gradient-to-br from-purple-50 to-purple-100 rounded-xl shadow-lg p-8 border-2 border-purple-200 hover:border-purple-400 transition-all duration-300 transform hover:scale-105">
                <div className="text-center">
                  ...
                  <h3 className="text-2xl font-bold text-gray-800 mb-3">Search Certificate</h3>
                  <p className="text-gray-700 mb-6 leading-relaxed">
        ...
        <div className="py-16 px-4 bg-gradient-to-br from-gray-50 to-blue-50">
          <div className="max-w-7xl mx-auto">
            <div className="text-center mb-12">
              ...
              <p className="text-xl text-gray-600">Simple steps to complete your birth registration</p>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
              ...
              <div className="text-center">
                ...
                <h3 className="text-xl font-bold text-gray-800 mb-2">Fill the Form</h3>
          ...
          <div className="max-w-7xl mx-auto">
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8 text-center">
              <div className="p-6">
                ...
                <div className="text-xl font-semibold text-gray-800 mb-2">Total Registrations</div>
                <p className="text-gray-600">Birth records handled through this system</p>
              </div>
              <div className="p-6">
                <div className="text-5xl font-bold text-green-600 mb-2">
                  {stats ? stats.approvedToday : '—'}
                </div>
                <div className="text-xl font-semibold text-gray-800 mb-2">Approved Today</div>
                <p className="text-gray-600">Certificates issued in the last 24 hours</p>
              </div>
              <div className="p-6">
                <div className="text-5xl font-bold text-purple-600 mb-2">
                  {stats ? stats.pendingApplications : '—'}
                </div>
                <div className="text-xl font-semibold text-gray-800 mb-2">Pending Applications</div>
                <p className="text-gray-600">Currently under review in the system</p>
              </div>
            </div>
          </div>
        </div>
