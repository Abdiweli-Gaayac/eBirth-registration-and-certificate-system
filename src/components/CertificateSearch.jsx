      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="bg-white rounded-t-lg shadow-lg border-b-4 border-blue-600 p-6 mb-6">
          <div className="flex items-center justify-center mb-4">
            ...
            <div>
              <h1 className="text-3xl font-bold text-gray-800">Certificate Search</h1>
              <p className="text-gray-600 mt-1">Search for birth certificates by certificate number or child name</p>
            </div>
          </div>
        </div>
              ...
              <div className="bg-white rounded-lg shadow-lg p-8">
                <div className="mb-6">
                  ...
                  <div className="flex items-center mb-6 pb-4 border-b-2 border-green-200">
                    ...
                    <div>
                      <h2 className="text-2xl font-bold text-gray-800">Certificate Found</h2>
                      <p className="text-gray-600">Birth certificate information retrieved successfully</p>
                    </div>
                  </div>
                  ...
                  <div className="bg-gray-50 rounded-lg p-6 mb-6 border border-gray-200">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                      <div>
                        ...
                        <p className="text-base font-semibold text-gray-800">{certificate.childInfo.fullName}</p>
                      </div>
                      <div>
